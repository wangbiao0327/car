...
class Ui_User_UI(object):
    def setupUi(self, User_UI):
        ...
        self.account_name_label.setGeometry(QtCore.QRect(490, 20, 180, 40))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(14)
        ...
        self.today_weather_label.setGeometry(QtCore.QRect(370, 100, 300, 40))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.today_weather_name_label.setGeometry(QtCore.QRect(230, 100, 121, 40))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(16)
    ...
    def retranslateUi(self, User_UI):
        ...
        self.today_weather_label.setText(_translate("User_UI", "<html><head/><body><p><span style=\" font-size:14pt; color:#ff0000;\">今日天气</span></p></body></html>"))
        self.today_weather_name_label.setText(_translate("User_UI", "<html><head/><body><p><span style=\" font-size:14pt; color:#ff0000;\">今日天气</span></p></body></html>"))
