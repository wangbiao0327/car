...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(570, 10, 101, 31))
        font = QtGui.QFont()
        font.setFamily("仿宋")
        font.setPointSize(14)
...
"}")
    ...
    def retranslateUi(self, User_UI):
        ...
        self.user_name_label.setText(_translate("User_UI", "用户名"))
        self.account_name_label.setText(_translate("User_UI", "17688893888"))
        ...
        self.pushButton.setText(_translate("User_UI", "注销"))
